                ...
                <div className="grid-4 margin-top-2rem">
                    ...
                    <div className="package-card gold">
                        ...
                        <div className="package-footer text-left">
                           <div>
                            ...
                            <Link to="/packages/gold" className="orange"><span>Book</span><i className="fas fa-arrow-right margin-left-10"/></Link>
                        </div>
                    </div>
                    ...
                    <div className="package-card silver">
                        ...
                        <div className="package-footer text-left">
                            ...
                            <Link to="/packages/silver" className="orange"><span>Book</span><i className="fas fa-arrow-right margin-left-10"/></Link>
                        </div>
                    </div>
                    ...
                    <div className="package-card bronze">
                        ...
                        <div className="package-footer text-left">
                            ...
                            <Link to="/packages/bronze" className="orange"><span>Book</span><i className="fas fa-arrow-right margin-left-10"/></Link>
                        </div>
                    </div>
                </div>
