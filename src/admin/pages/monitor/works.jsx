            ...
            <main className="main">
                ...
                <div className="contents">
                    <nav className="page-nav">
                        ...
                        <Link to="/admin/monitor/works" className="page-active">Monitor works</Link>
                    </nav>
                    <div className="opening">
                        <div className="opening-header">
                            <h3>Monitor works</h3>
                            <Link to="/admin/create/project" className="link"><i className="fas fa-plus-circle"/><span>Create</span></Link>
                        </div>
                    </div>
                    <div className="works-table margin-top-2rem" style={{backgroundColor: "#ffffff", padding: "20px", borderRadius: "10px"}}>
